...
echo ---------------------------------------------------------------------------- > ExcusalDetailReport_PROD.log 2>&1
set _current_datetime=%date%_%time%
echo %_current_datetime% >> ExcusalDetailReport_PROD.log 2>&1
python data_parallel_export_all_tables.py .\config\TBOSRPT\PROD\ExcusalDetailReport.json [] >> ExcusalDetailReport_PROD.log 2>&1
