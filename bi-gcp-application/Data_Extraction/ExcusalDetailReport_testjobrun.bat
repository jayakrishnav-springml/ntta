...
echo ---------------------------------------------------------------------------- > ExcusalDetailReport_TEST.log 2>&1
set _current_datetime=%date%_%time%
echo %_current_datetime% >> ExcusalDetailReport_TEST.log 2>&1
python data_parallel_export_all_tables.py .\config\TBOSRPT\TEST\ExcusalDetailReport.json [] >> ExcusalDetailReport_TEST.log 2>&1
