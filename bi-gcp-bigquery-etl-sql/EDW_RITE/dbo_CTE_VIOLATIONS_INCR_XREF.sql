...
## Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/EDW_RITE/Tables/dbo_CTE_VIOLATIONS_INCR_XREF.sql
## Translated from: SqlServer
## Translated to: BigQuery

CREATE TABLE IF NOT EXISTS EDW_RITE.Cte_Violations_Incr_Xref
(
  month_id INT64,
  day_id INT64,
