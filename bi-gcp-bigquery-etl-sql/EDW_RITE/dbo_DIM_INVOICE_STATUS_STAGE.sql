...
## Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/EDW_RITE/Tables/dbo_DIM_INVOICE_STATUS_STAGE.sql
## Translated from: SqlServer
## Translated to: BigQuery

CREATE TABLE IF NOT EXISTS EDW_RITE.Dim_Invoice_Status_Stage
(
  zi_stage_id INT64 NOT NULL,
  vbi_status STRING NOT NULL,
  viol_inv_status STRING NOT NULL,
  zi_stage_name STRING NOT NULL,
  vbi_status_desc STRING,
