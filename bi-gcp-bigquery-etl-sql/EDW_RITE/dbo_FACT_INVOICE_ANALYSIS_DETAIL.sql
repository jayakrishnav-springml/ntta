...
## Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/EDW_RITE/Tables/dbo_FACT_INVOICE_ANALYSIS_DETAIL.sql
## Translated from: SqlServer
## Translated to: BigQuery

CREATE TABLE IF NOT EXISTS EDW_RITE.Fact_Invoice_Analysis_Detail
(
  ...
  last_violator_id INT64 NOT NULL,
  transaction_id INT64 NOT NULL,
  disposition STRING NOT NULL,
  vps_host_posted_revenue NUMERIC(33, 4) NOT NULL,
