...
## Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/EDW_RITE/Tables/dbo_FACT_INVOICE_ANALYSIS_STAGE.sql
## Translated from: SqlServer
## Translated to: BigQuery

CREATE TABLE IF NOT EXISTS EDW_RITE.Fact_Invoice_Analysis_Stage
(
  violator_id INT64,
  ...
  vb_inv_due_date DATETIME NOT NULL,
  vb_inv_date_excused DATE NOT NULL,
  vb_inv_excused_by STRING,
  vb_inv_date_modified DATETIME NOT NULL,
  ...
  viol_inv_due_date DATETIME NOT NULL,
  ...
  first_citation_nbr STRING NOT NULL,
  last_citation_nbr STRING NOT NULL,
  citation_nbr_list STRING NOT NULL,
  citation_nbr_count INT64 NOT NULL,
  first_ca_acct_id NUMERIC(29) NOT NULL,
  last_ca_acct_id NUMERIC(29) NOT NULL,
  ...
  amt_paid BIGNUMERIC(42, 4) NOT NULL,
