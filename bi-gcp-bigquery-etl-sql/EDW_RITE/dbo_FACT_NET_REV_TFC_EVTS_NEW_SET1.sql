...
## Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/EDW_RITE/Tables/dbo_FACT_NET_REV_TFC_EVTS_NEW_SET1.sql
## Translated from: SqlServer
## Translated to: BigQuery

CREATE TABLE IF NOT EXISTS EDW_RITE.Fact_Net_Rev_Tfc_Evts_New_Set1
(
  day_id INT64,
  month_id INT64,
