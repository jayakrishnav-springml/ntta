...
## Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/EDW_RITE/Tables/dbo_FACT_NOT_TRANSFERRED_TO_VPS_DETAIL_OLD.sql
## Translated from: SqlServer
## Translated to: BigQuery

CREATE TABLE IF NOT EXISTS EDW_RITE.Fact_Not_Transferred_To_Vps_Detail_Old
(
  day_id INT64,
  month_id INT64,
  lane_id INT64,
