...
## Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/EDW_RITE/Tables/dbo_PAYMENTS_VPS_DETAIL_CHANGE.sql
## Translated from: SqlServer
## Translated to: BigQuery

CREATE TABLE IF NOT EXISTS EDW_RITE.Payments_Vps_Detail_Change
(
  day_id INT64,
  month_id INT64,
  payment_id INT64,
