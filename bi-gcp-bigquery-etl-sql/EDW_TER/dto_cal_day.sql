...
CREATE TABLE IF NOT EXISTS EDW_TER.Dto_Cal_Day
(
  cal_id INT64 NOT NULL,
  cal_day_bgn DATE NOT NULL,
  cal_day_end DATE NOT NULL,
  cal_day_ix INT64,
  cal_day_typ_id INT64 NOT NULL,
  cal_day_typ_grp_id INT64 NOT NULL,
