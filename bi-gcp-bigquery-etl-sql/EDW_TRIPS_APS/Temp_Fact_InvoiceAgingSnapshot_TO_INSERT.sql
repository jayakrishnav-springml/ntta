...
## Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/EDW_TRIPS/Tables/Temp_Fact_InvoiceAgingSnapshot_TO_INSERT.sql
## Translated from: SqlServer
## Translated to: BigQuery

CREATE TABLE IF NOT EXISTS EDW_TRIPS_APS.Fact_InvoiceAgingSnapshot_TO_INSERT
(
  snapshotdate DATE,
