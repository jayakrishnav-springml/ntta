...
## Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/EDW_TRIPS/Tables/Temp_Fact_UnifiedTransaction_SummarySnapshot_BKUP_B4_UPD_20221203.sql
## Translated from: SqlServer
## Translated to: BigQuery

CREATE TABLE IF NOT EXISTS EDW_TRIPS_APS.Fact_UnifiedTransaction_SummarySnapshot_BKUP_B4_UPD_20221203
(
