...
## Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/EDW_TRIPS/Tables/Temp_LEFTOVER_OLD_Fact_Violation_INCR_FULL_LOAD_09182023.sql
## Translated from: SqlServer
## Translated to: BigQuery

CREATE TABLE IF NOT EXISTS EDW_TRIPS_APS.LEFTOVER_OLD_Fact_Violation_INCR_FULL_LOAD_09182023
(
