CREATE OR REPLACE PROCEDURE `EDW_TRIPS_SUPPORT.Set_UpdatedDate`(table_name STRING, source_name STRING, OUT last_updated_date DATETIME)
BEGIN
...
*/
    ...
    DELETE FROM EDW_TRIPS_SUPPORT.loadprocesscontrol WHERE loadprocesscontrol.tablename = fullname;
    ...
    IF last_updated_date IS NOT NULL THEN
      INSERT INTO EDW_TRIPS_SUPPORT.loadprocesscontrol (tablename, lastupdateddate, edw_updatedate)
