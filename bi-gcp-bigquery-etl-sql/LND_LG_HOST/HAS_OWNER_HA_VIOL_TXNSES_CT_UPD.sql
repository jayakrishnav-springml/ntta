...
-- Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/LND_LG_HOST/Tables/HAS_OWNER_HA_VIOL_TXNSES_CT_UPD.sql
-- Translated from: SqlServer
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS LND_LG_HOST.Has_Owner_Ha_Viol_Txnses_Ct_Upd
(
