...
-- Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/LND_LG_IOP/Tables/IOP_OWNER_HUB_LVL_PLATE_DETAILS_HISTORY.sql
-- Translated from: SqlServer
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS LND_LG_IOP.Iop_Owner_Hub_Lvl_Plate_Details_History
(
  hub_lvl_plate_dtls_hist_id NUMERIC(29) NOT NULL,
  ...
  date_lvl_expired DATETIME NOT NULL,
  ...
  last_inc_lvl_batch_id BIGNUMERIC(48, 10),
