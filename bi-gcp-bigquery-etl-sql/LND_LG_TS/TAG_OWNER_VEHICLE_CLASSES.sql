...
-- Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/LND_LG_TS/Tables/TAG_OWNER_VEHICLE_CLASSES.sql
-- Translated from: SqlServer
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS LND_LG_TS.Tag_Owner_Vehicle_Classes
(
  vehicle_class_code STRING NOT NULL,
  vehicle_class_descr STRING NOT NULL,
  vehicle_class_long_descr STRING,
  vehicle_class_order INT64,
