...
-- Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/LND_NAGIOS/Tables/dbo_nagios_hoststatus.sql
-- Translated from: SqlServer
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS LND_NAGIOS.Nagios_HostStatus
(
  hoststatus_id INT64,
  instance_id INT64,
...
cluster by host_object_id
;

/*alter for CDC changes*/

ALTER TABLE LND_NAGIOS.Nagios_HostStatus ADD COLUMN IF NOT EXISTS lnd_updatetype STRING, ADD COLUMN IF NOT EXISTS src_changedate DATETIME;