...
-- Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/LND_NAGIOS/Tables/dbo_nagios_hoststatus_HIST.sql
-- Translated from: SqlServer
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS LND_NAGIOS.Nagios_HostStatus_Hist
(
  hoststatus_id INT64,
  instance_id INT64,
...
cluster by status_update_time,host_object_id
;
