...
CREATE TABLE IF NOT EXISTS LND_NAGIOS_STAGE_CDC.Nagios_Hosts
(
...
ALTER TABLE LND_NAGIOS_STAGE_CDC.Nagios_Hosts ADD COLUMN IF NOT EXISTS lnd_updatetype STRING, ADD COLUMN IF NOT EXISTS src_changedate DATETIME;
