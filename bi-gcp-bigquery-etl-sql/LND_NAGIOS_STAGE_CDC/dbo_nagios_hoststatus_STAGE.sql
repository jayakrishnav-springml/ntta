...
CREATE TABLE IF NOT EXISTS LND_NAGIOS_STAGE_CDC.Nagios_HostStatus
(
  hoststatus_id INT64,
  instance_id INT64,
...
ALTER TABLE LND_NAGIOS_STAGE_CDC.Nagios_HostStatus ADD COLUMN IF NOT EXISTS lnd_updatetype STRING, ADD COLUMN IF NOT EXISTS src_changedate DATETIME;
