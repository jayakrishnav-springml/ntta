...
CREATE TABLE IF NOT EXISTS LND_NAGIOS_STAGE_FULL.Nagios_HostGroup_Members
(
...
ALTER TABLE LND_NAGIOS_STAGE_FULL.Nagios_HostGroup_Members ADD COLUMN IF NOT EXISTS lnd_updatetype STRING, ADD COLUMN IF NOT EXISTS src_changedate DATETIME;
