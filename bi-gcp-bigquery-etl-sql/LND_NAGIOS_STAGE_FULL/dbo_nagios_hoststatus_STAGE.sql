...
-- Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/LND_NAGIOS/Tables/dbo_nagios_hoststatus_STAGE.sql
-- Translated from: SqlServer
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS LND_NAGIOS_STAGE_FULL.Nagios_HostStatus
(
  hoststatus_id INT64,
  instance_id INT64,
  ...
  last_time_up DATETIME,
  last_time_down DATETIME,
  last_time_unreachable DATETIME,
  state_type INT64,
...
ALTER TABLE LND_NAGIOS_STAGE_FULL.Nagios_HostStatus ADD COLUMN IF NOT EXISTS lnd_updatetype STRING, ADD COLUMN IF NOT EXISTS src_changedate DATETIME;
