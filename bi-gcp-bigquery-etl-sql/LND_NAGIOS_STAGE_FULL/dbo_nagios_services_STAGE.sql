...
CREATE TABLE IF NOT EXISTS LND_NAGIOS_STAGE_FULL.Nagios_Services
(
  service_id INT64,
  instance_id INT64,
  config_type INT64,
...
ALTER TABLE LND_NAGIOS_STAGE_FULL.Nagios_Services ADD COLUMN IF NOT EXISTS lnd_updatetype STRING, ADD COLUMN IF NOT EXISTS src_changedate DATETIME;
