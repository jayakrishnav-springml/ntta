...
## Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/LND_TBOS/Tables/DocMgr_TP_Customer_OutboundCommunications.sql
## Translated from: SqlServer
## Translated to: BigQuery

CREATE TABLE IF NOT EXISTS LND_TBOS.DocMgr_TP_Customer_OutboundCommunications
(
