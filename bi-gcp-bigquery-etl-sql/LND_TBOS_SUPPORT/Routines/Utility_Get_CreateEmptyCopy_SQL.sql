CREATE OR REPLACE PROCEDURE LND_TBOS_SUPPORT.Get_CreateEmptyCopy_SQL(IN table STRING, IN new_table_name STRING, INOUT params_in_sql_out STRING)
  BEGIN
    ...
    ELSE
      BEGIN
        ...
        SET params_in_sql_out = concat(params_in_sql_out, code_points_to_string(ARRAY[
          ...
          13
        ]), 'FROM ', '[LND_TBOS.', table, ']', code_points_to_string(ARRAY[
          13
        ]), 'WHERE 1 = 2');
