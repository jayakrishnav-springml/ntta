...
## ERROR_OTHER: Parser failed: After CREATE TABLE IF NOT EXISTS sql_identifier ( create_table_element_list , sql_identifier_part type_specifier NOT, got bare_identifier(NULLDEFAULT) but expected [NULL].
## Error During Batch Translate , Fixed Source Manually by Adding one Space Between NOT NULL and DEFAULT ,Able to Translate

CREATE TABLE IF NOT EXISTS LND_TBOS_SUPPORT.TableLoadParameters
(
