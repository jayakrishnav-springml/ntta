...
-- Source: ntta-gcp-poc-source-code-scripts/APS1_DDLs_latest/LND_TER/Tables/dbo_BanActionLookup.sql
-- Translated from: SqlServer
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS LND_TER.BanActionLookup
(
  banactionlookupid INT64 NOT NULL,
  descr STRING NOT NULL,
  actionsequencenbr INT64 NOT NULL,
